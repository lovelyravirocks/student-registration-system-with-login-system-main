...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank"><img src="./upload_images/logo.png" alt="" width="350px" ></a><br><hr>
		...
		<thead>
			<tr>
			   <th class="text-center" scope="col">S.L</th>
				...
				<th class="text-center" scope="col">Aadhar</th>
				<th class="text-center" scope="col">Enroll</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><img src="https://alliedhealthcarecouncilofindia.com/wp-content/uploads/2020/07/Untitled-2.png" width="300px" height="80px" alt=""></center>
...
<div class="form-group col-md-6">
<label for="mothername">D.O.B</label>
...
<div class="form-group col-md-6">
<label for="aadharno">Enrollment.</label>
...
<label for="family">Insitute Name</label>
...
while($row = mysqli_fetch_array($run_data))
{
	...
	echo "
		...
		<div class='modal-dialog'>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-6 col-md-2'>
									<img src='http://localhost/student-registration-system-with-login-system-main/upload_images/logo.png' class='img-responsive'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<strong>Name :</strong> $name $name2 <br>
						<strong>Course :</strong> $email <br>
						<strong>Registration No. :</strong>$phone  <br>
						<strong>W/S/D/O :</strong> $father <br>
						<strong>D.O.B : </strong>$mother <br>
						<strong>Aadhar :</strong> $aadhar <br>
						<strong>Gender :</strong> $gender<br />
						<strong>Insitute Name : </strong> $family <br>
						<strong>Address : </strong> $village, $dist, $state - $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
			...
			<div class='modal-footer'>
			<div class='col-md-6'><center><h3>IDENTITY CARD</h3></center></div>
			<div class='col-md-6'><img src='http://www.alliedhealthcarecouncilofindia.com/wp-content/uploads/sign.jpg' style='height:60px'></div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='mothername'>D.O.B</label>
		<input type='date' class='form-control' name='user_mother' placeholder='Enter Last Name' value='$mother'>
		</div>
		</div>
